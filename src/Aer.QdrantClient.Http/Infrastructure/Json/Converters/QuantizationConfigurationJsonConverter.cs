...
internal class QuantizationConfigurationJsonConverter : JsonConverter<QuantizationConfiguration>
{
    public override QuantizationConfiguration Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        throw new QdrantJsonParsingException("Unbable to deserialize Qdrant collection quantization configuration value");
    }
    ...
    public override void Write(Utf8JsonWriter writer, QuantizationConfiguration value, JsonSerializerOptions options)
    {
        ...
        if (value is QuantizationConfiguration.ScalarQuantizationConfiguration sc)
        {
        ...
        if (value is QuantizationConfiguration.ProductQuantizationConfiguration pc)
        {
        ...
        if (value is QuantizationConfiguration.BinaryQuantizationConfiguration bc)
        {
        ...
        throw new QdrantJsonSerializationException("Unbable to serialize Qdrant collection quantization configuration value");
    }
}
